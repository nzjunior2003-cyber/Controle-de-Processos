  ...
  const handleSalvar = async () => {
    ...
    try {
      const dados: Omit<Contrato, 'id'> = {
        ...
        contatosFornecedor: form.contatosFornecedor || undefined,
        ...
        fiscalTitular: form.fiscalTitular || undefined,
        fiscalEmail: form.fiscalEmail || undefined,
        fiscalTitularContato: form.fiscalTitularContato || undefined,
        fiscalSuplente: form.fiscalSuplente || undefined,
        fiscalSuplenteEmail: form.fiscalSuplenteEmail || undefined,
        fiscalSuplenteContato: form.fiscalSuplenteContato || undefined,
        portaria: form.portaria || undefined,
        fonteRecurso: form.fonteRecurso || undefined,
        prd: form.prd || undefined,
        empenho: form.empenho || undefined,
        dotacao: form.dotacao || undefined,
