...
export default function DashboardApoio() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Dashboard de Apoio e Suprimento</h1>
        <p className="mt-1 text-sm text-gray-500">Monitore o fluxo dos processos e identifique gargalos.</p>
      </div>
